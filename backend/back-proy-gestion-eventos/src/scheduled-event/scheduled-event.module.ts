...
@Module({imports:[TypeOrmModule.forFeature([ScheduledEvent]),UsersModule,InstitutionsModule,MailModule],
    controllers: [ScheduledEventController],
    providers: [ScheduledEventService,UsersService,InstitutionsService,MailService],
